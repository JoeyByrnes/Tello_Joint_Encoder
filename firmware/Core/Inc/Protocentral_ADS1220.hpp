...
#define WREG  (uint8_t)0x40
#define RREG  (uint8_t)0x20
...
class Protocentral_ADS1220
{
      ...
      public:
            ...
            void begin(GPIO_TypeDef* cs_port, uint16_t cs_pin, GPIO_TypeDef* drdy_port, uint16_t drdy_pin);
            ...
            void Start_SingleShot_Conv(void);
            uint8_t* Read_Data_Immediate();
